            ...
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">Streamline your healthcare experience with our user-friendly website. Easily book and manage appointments 24/7, providing a seamless and efficient solution for both patients and healthcare providers.
                  </p>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center">Know More about our Doctor</h2>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center">How to find us</h2>
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Our Medical Office is on QRCG+R6W, Av. du combattant suprême, Monastir
                </p>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                Effortless appointment booking. Simplify your schedule with our user-friendly platform.
                </p>
          ...
          <div className="container">
            <div className="flex items-center justify-between flex-col lg:flex-row">
              ...
              <div className="xl:w-[670px]">
                <h2 className="heading">Get Virtual treatment <br /> SOON</h2>

                <ul className="pl-4">
                  <li className="text__para">1. Schedule the appointment directly.</li>
                  <li className="text__para">2. Search for you physician here, and contact their office.</li>
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0 ">
                ...
                <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 
                  ...
                  <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] 
                    lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-blue-600
